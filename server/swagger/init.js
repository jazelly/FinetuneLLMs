...
const doc = {
  info: {
    version: "1.0.0",
    title: "FinetuneLLMs Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your FinetuneLLMs instance. UI supplied by Swagger.io.",
  },
