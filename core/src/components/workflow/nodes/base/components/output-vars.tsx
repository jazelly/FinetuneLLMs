  ...
  return (
    <div>
      <div
        ...
        className={cn(
          className,
          'flex justify-between leading-[18px] text-[13px] font-semibold text-gray-700 uppercase cursor-pointer'
        )}
      >
        <div>{title || 'Output Variables'}</div>
        <ArrowArcRight
  ...
  return (
    <div className="py-1">
      <div className="flex leading-[18px] items-center">
        ...
        <div className="ml-2 text-xs font-normal text-gray-500 capitalize">
          {type}
        </div>
      </div>
