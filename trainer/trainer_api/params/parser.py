...
_INFER_ARGS = [ModelArguments, DataArguments, FinetuningArguments, InferenceArguments]
_INFER_CLS = Tuple[
    ModelArguments, DataArguments, FinetuningArguments, InferenceArguments
]
...
def _check_extra_dependencies(
    ...
    if model_args.mixture_of_depths is not None:
        require_version(
            "mixture-of-depth>=1.1.6", "To fix: pip install mixture-of-depth>=1.1.6"
        )
