  ...
  return (
    <div className="absolute top-3 right-4 md:top-9 md:right-10 w-fit h-fit z-99">
      <button
        ...
        type="button"
        className="uppercase transition-all duration-300 w-[35px] h-[35px] text-base font-semibold rounded-full flex items-center bg-main-button hover:bg-menu-item-selected-gradient justify-center text-white p-2 hover:border-slate-100 hover:border-opacity-50 border-transparent border"
      >
      ...
      {showMenu && (
        <div
          ref={menuRef}
          className="w-fit rounded-lg absolute top-12 right-0 bg-main p-4 flex items-center-justify-center"
        >
