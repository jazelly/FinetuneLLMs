...
const Editor: FC<Props> = ({
  ...
  const isShowHistory = !l && isChatApp;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="leading-4 text-xs font-semibold text-gray-700 uppercase">
              {title}
            </div>
            <div className="flex items-center">
              <div className="leading-[18px] text-xs font-medium text-gray-500">
                {value?.length || 0}
              </div>
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        'flex h-[22px] items-center px-1.5 rounded-[5px] border border-transparent hover:border-black/5 space-x-0.5'
                      )}
                    >
            ...
            {!(isSupportJinja && editionType === EditionType.jinja2) ? (
              <div
                className={cn(
                  ...
                  'relative px-3 min-h-[56px]  overflow-y-auto'
                )}
              >
                <PromptEditor
