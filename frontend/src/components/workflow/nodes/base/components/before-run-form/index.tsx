...
import Toast from '@/components/reusable/Toast.component';
import { Spinner, StopCircle, X } from '@phosphor-icons/react';
import Split from '../split';
import { Button } from '@/components/reusable/Button.component';
        ...
        <div className="h-0 grow overflow-y-auto pb-4">
          ...
          <div className="mt-4 flex justify-between space-x-2 px-4">
            ...
            <Button
              ...
              type="primary"
              className="w-0 grow !h-8 flex items-center space-x-2 text-[13px]"
              onClick={handleRun}
            >
              {isRunning && (
                <Spinner className="animate-spin w-4 h-4 text-white" />
              )}
              <div>
